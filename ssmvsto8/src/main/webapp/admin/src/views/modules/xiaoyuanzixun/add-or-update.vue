<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="编辑" prop="bianji">
          <el-input v-model="ruleForm.bianji" 
              placeholder="编辑" clearable  :readonly="ro.bianji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="编辑" prop="bianji">
              <el-input v-model="ruleForm.bianji" 
                placeholder="编辑" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="资讯简介" prop="zixunjianjie">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zixunjianjie" label="资讯简介" prop="zixunjianjie">
                    <span>{{ruleForm.zixunjianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.zixunneirong = this.ruleForm.zixunneirong.replace(reg,'../../../ssmvsto8/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xiaoyuanzixun/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiaoyuanzixunCrossAddOrUpdateFlag = false;
                  this.parent.search();
