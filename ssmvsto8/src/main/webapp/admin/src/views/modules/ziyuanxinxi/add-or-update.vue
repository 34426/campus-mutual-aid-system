    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="资源类型" prop="ziyuanleixing">
          <el-select v-model="ruleForm.ziyuanleixing" placeholder="请选择资源类型">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发布者账号" prop="fabuzhezhanghao">
          <el-input v-model="ruleForm.fabuzhezhanghao" 
              placeholder="发布者账号" clearable  :readonly="ro.fabuzhezhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发布者账号" prop="fabuzhezhanghao">
              <el-input v-model="ruleForm.fabuzhezhanghao" 
                placeholder="发布者账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发布者姓名" prop="fabuzhexingming">
          <el-input v-model="ruleForm.fabuzhexingming" 
              placeholder="发布者姓名" clearable  :readonly="ro.fabuzhexingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发布者姓名" prop="fabuzhexingming">
              <el-input v-model="ruleForm.fabuzhexingming" 
                placeholder="发布者姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="资源描述" prop="ziyuanmiaoshu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.ziyuanmiaoshu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.ziyuanmiaoshu" label="资源描述" prop="ziyuanmiaoshu">
                    <span v-html="ruleForm.ziyuanmiaoshu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	tupian : false,
	lianxidianhua : false,
	fabuzhezhanghao : false,
	fabuzhexingming : false,
	sfsh : false,
	shhf : false,
      },
      ruleForm: {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiage = true;
          ...
          if(o=='ziyuanmiaoshu'){
            this.ruleForm.ziyuanmiaoshu = obj[o];
	    this.ro.ziyuanmiaoshu = true;
            continue;
          }
          if(o=='tupian'){
	    ...
	    this.ro.lianxidianhua = true;
          ...
          if(o=='fabuzhezhanghao'){
            this.ruleForm.fabuzhezhanghao = obj[o];
	    this.ro.fabuzhezhanghao = true;
            continue;
          }
          if(o=='fabuzhexingming'){
            this.ruleForm.fabuzhexingming = obj[o];
	    this.ro.fabuzhexingming = true;
            continue;
          }
        }
      }
      ...
      this.$http({
		...
		if(json.fabuzhezhanghao!=''&&json.fabuzhezhanghao){
              		this.ruleForm.fabuzhezhanghao = json.fabuzhezhanghao
	    		this.ro.fabuzhezhanghao = true;
		}
		if(json.fabuzhexingming!=''&&json.fabuzhexingming){
              		this.ruleForm.fabuzhexingming = json.fabuzhexingming
	    		this.ro.fabuzhexingming = true;
		}
        } else {
	...
	this.ruleForm.ziyuanmiaoshu = this.ruleForm.ziyuanmiaoshu.replace(reg,'../../../ssmvsto8/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
