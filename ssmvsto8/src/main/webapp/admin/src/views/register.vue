  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:rgba(36, 194, 205, 1);fontSize:28px;">校内互助交易平台注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='fabuzhe'" class="input-group">
			   <div class="label">发布者账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.fabuzhezhanghao" class="input" type="text" placeholder="发布者账号">
			   </div>
			 </div> -->
			<el-form-item label="发布者账号" class="input" v-if="tableName=='fabuzhe'">
			  <el-input v-model="ruleForm.fabuzhezhanghao" autocomplete="off" placeholder="发布者账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='fabuzhe'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<!-- <div v-if="tableName=='fabuzhe'" class="input-group">
			   <div class="label">发布者姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.fabuzhexingming" class="input" type="text" placeholder="发布者姓名">
			   </div>
			 </div> -->
			<el-form-item label="发布者姓名" class="input" v-if="tableName=='fabuzhe'">
			  <el-input v-model="ruleForm.fabuzhexingming" autocomplete="off" placeholder="发布者姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='fabuzhe'" class="input-group">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='fabuzhe'">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='fabuzhe'">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='fabuzhe'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证"  />
			</el-form-item>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.fabuzhezhanghao) && `fabuzhe` == this.tableName){
        this.$message.error(`发布者账号不能为空`);
        return
      }
      ...
      if((!this.ruleForm.fabuzhexingming) && `fabuzhe` == this.tableName){
        this.$message.error(`发布者姓名不能为空`);
        return
      }
      if(`fabuzhe` == this.tableName && this.ruleForm.lianxidianhua&&(!this.$validate.isMobile(this.ruleForm.lianxidianhua))){
        this.$message.error(`联系电话应输入手机格式`);
        return
      }
      if(`fabuzhe` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
        this.$message.error(`邮箱应输入邮件格式`);
        return
      }
      if(`fabuzhe` == this.tableName && this.ruleForm.shenfenzheng&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzheng))){
        this.$message.error(`身份证应输入身份证格式`);
        return
      }
      this.$http({
